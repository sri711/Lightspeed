...
# Set up the Gemini API using key from environment
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")
if not GEMINI_API_KEY:
    st.error("Gemini API key is missing. Please set GEMINI_API_KEY in your environment.")
genai.configure(api_key=GEMINI_API_KEY)

# If needed, you can similarly load the ElevenLabs key when required:
